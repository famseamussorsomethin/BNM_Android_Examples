...
//! BNM::UnityEngine::Object is needed if the object inherits UnityEngine.MonoBehaviour or UnityEngine.ScriptableObject
struct BNM_ExampleObject : public BNM::UnityEngine::Object {
    BNM_NewClassInit("BNM_Example_03", BNM_ExampleObject, {
        ...
        //! BNM::LoadClass accepts the DLL name as the third argument (can be with or without '.dll')
    ...
    // To override virtual methods, types must match exactly
